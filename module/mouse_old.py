...
class Mouse:
    ...
    def __init__(self, screen_x, screen_y):
        ...
        self.dev.enable(libevdev.EV_ABS.ABS_X,
                libevdev.InputAbsInfo(minimum=0, maximum=screen_x, resolution=100))
        # Send absolute Y coordinate
        self.dev.enable(libevdev.EV_ABS.ABS_Y,
                libevdev.InputAbsInfo(minimum=0, maximum=screen_y, resolution=100))
    ...
    def press(self, x, y, blobSize, sizeMax, sizeMin, screen_X):
        self.release()
        print("press")
        if (blobSize > sizeMax):
            blobSize = sizeMax
        ...
        pressure = 546.07*(sizeMax + sizeMin - blobSize - factor) # 546 == 8191/15 == maxpressure / maxblobsize(from 0 to i)
